...
<head>
    ...
    <link href="<?php echo $urls_base;?>cl/css/animate.min.css" rel="stylesheet">
    <link href="<?php echo $urls_base;?>cl/css/owl.carousel.css" rel="stylesheet">
    <link href="<?php echo $urls_base;?>cl/css/owl.transitions.css" rel="stylesheet">
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo $urls_base;?>?c=home"><img src="<?php echo $urls_base;?>cl/images/logo.png" alt="logo"></a>
                </div>
				
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="scroll active"><a href="#home">Home</a></li>
                        <li class="scroll"><a href="#"onclick="javascript:ap('c=product&a=product_upload_pre','main-container',true)">Products</a></li>
                        <li class="scroll"><a href="#services">Services</a></li>
                        <li class="scroll"><a href="#portfolio"><?php echo $port;?></a></li>
                        <li class="scroll"><a href="#about">About</a></li>
                        <li class="scroll"><a href="#meet-team">Team</a></li>
                        <li class="scroll"><a href="#pricing">Pricing</a></li>
                        <li class="scroll"><a href="#blog">Blog</a></li> 
                        <li class="scroll"><a href="#tutorials">Tutorials</a></li> 
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image: url(<?php echo $urls_base;?>cl/images/slider/bg1.jpg);">
             ...
             <div class="item" style="background-image: url(<?php echo $urls_base;?>cl/images/slider/bg2.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
  ...
  <section id="product">
        <div class="container">
            ...
            <div class="text-center">
                <ul class="portfolio-filter">
                    ...
                    <li><a href="#" data-filter=".creative">Logo</a></li>
                    <li><a href="#" data-filter=".corporate">Template</a></li>
                    <li><a href="#" data-filter=".portfolio">Web Development</a></li>
                </ul><!--/#portfolio-filter-->
            </div>
            ...
            <div class="portfolio-items">
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/portfolio/01.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 1</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="<?php echo $urls_base;?>cl/images/portfolio/full.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item corporate portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/portfolio/02.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/portfolio/03.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/portfolio/04.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/portfolio/05.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/portfolio/06.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 5</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="<?php echo $urls_base;?>cl/images/portfolio/full.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/portfolio/07.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/portfolio/08.jpg" alt="">
                        <div class="portfolio-info">
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                ...
                <img class="img-responsive wow fadeIn" src="<?php echo $urls_base;?>cl/images/cta2/cta2-img.png" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <div class="team-img">
                            <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/team/01.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Bin Burhan</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="team-img">
                            <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/team/02.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Jane Man</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="team-img">
                            <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/team/03.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Pahlwan</h3>
                            <span>Designer</span>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        <div class="team-img">
                            <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/team/04.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Nasir uddin</h3>
                            <span>UI/UX</span>
                    ...
                    <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <p><img class="img-circle img-thumbnail" src="<?php echo $urls_base;?>cl/images/testimonial/01.jpg" alt=""></p>
            ...
            <div class="row">
                        ...
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/blog/01.jpg" alt="">
                ...
                <div class="col-sm-6">
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/blog/02.jpg" alt="">
                    ...
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="200ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="<?php echo $urls_base;?>cl/images/blog/03.jpg" alt="">
    ...
    <section id="tutorials">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Tutorials</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>

            <div class="text-center">
                <ul class="portfolio-filter">
                    <li><a class="active" href="#" data-filter="*">All tutorisls</a></li>
                    <li><a href="#" data-filter=".creative">Photoshop</a></li>
                    <li><a href="#" data-filter=".corporate">HTML & CSS</a></li>
                    <li><a href="#" data-filter=".portfolio">PHP</a></li>
                </ul><!--/#portfolio-filter-->
            </div>
    ...
    <script src="<?php echo $urls_base;?>cl/js/owl.carousel.min.js"></script>
    <script src="<?php echo $urls_base;?>cl/js/mousescroll.js"></script>
    <script src="<?php echo $urls_base;?>cl/js/smoothscroll.js"></script>
    <script src="<?php echo $urls_base;?>cl/js/jquery.prettyPhoto.js"></script>
    <script src="<?php echo $urls_base;?>cl/js/jquery.isotope.min.js"></script>
    <script src="<?php echo $urls_base;?>cl/js/jquery.inview.min.js"></script>
    <script src="<?php echo $urls_base;?>cl/js/wow.min.js"></script>
